...
export const SimulatorTab = () => {
  ...
  const calculateResults = () => {
    ...
    const totalCosts = config.costPerTrade * (config.wins + config.losses + config.draws)
    ...
    const totalTradesCalc = config.wins + config.losses + config.draws
    const winRate = totalTradesCalc > 0 ? (config.wins / totalTradesCalc) * 100 : 0
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-red-500">
                  {formatCurrency(-results.totalLossAmount)}
                </span>
              </div>
              ...
              <div className="text-center">
                ...
                <div
                  className={`text-4xl font-bold ${
                    results.finalProfit >= 0 ? 'text-green-500' : 'text-red-500'
                  }`}
                >
                ...
                <div className="text-center">
                  ...
                  <div
                    className={`text-xl font-bold ${
                      results.returnPercent >= 0 ? 'text-green-500' : 'text-red-500'
                    }`}
                  >
