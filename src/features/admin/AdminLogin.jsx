  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      const userCredential = await signInWithEmailAndPassword(auth, email, password)
            await checkIsAdmin(userCredential.user.uid)
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 shadow-2xl">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-white/50"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-white hover:bg-purple-100 disabled:bg-white/50 text-purple-900 font-bold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:cursor-not-allowed"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-purple-900/50 text-purple-200">OU</span>
            </div>
          </div>
