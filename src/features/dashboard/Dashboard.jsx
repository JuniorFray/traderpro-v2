      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <div className="space-y-2">
            ...
            <p className="text-xs text-zinc-500">Média: {(metrics.averageWin || 0).toFixed(2)} $</p>
          </div>
        </Card>
        ...
        <Card>
          <div className="space-y-2">
            ...
            <p className="text-xs text-zinc-500">Média: {(metrics.averageLoss || 0).toFixed(2)} $</p>
          </div>
        </Card>
        ...
        <Card>
          <div className="space-y-2">
            ...
            <p className="text-xl font-bold text-win">+{(metrics.bestTrade || 0).toFixed(2)} $</p>
            <p className="text-xl font-bold text-loss">{(metrics.worstTrade || 0).toFixed(2)} $</p>
          </div>
        </Card>
      </div>
    </div>
